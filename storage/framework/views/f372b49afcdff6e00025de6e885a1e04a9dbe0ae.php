          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="data-admin" class="table table-bordered table-hover">
                ...
                <?php $no = 1 ?>
                <tbody>
                  <?php $__currentLoopData = $carousel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td><?php echo e($no++); ?></td>
                      <td><?php echo e($slider->slider_image); ?></td>
                      <td>
                        <form action="<?php echo e(route('slider.delete', $slider->id)); ?>" class="form-horizontal" method="post">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form class="form-horizontal" action="<?php echo e(route('slider.insert')); ?>" method="post" enctype="multipart/form-data">
              <?php echo e(csrf_field()); ?>
