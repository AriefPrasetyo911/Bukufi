                    ...
                    <div class="tab-content" style="padding: 15px;">
                      <div role="tabpanel" class="tab-pane active" id="today">
                        ...
                        <table class="table table-responsive table-striped" id="table-log" width="100%">
                          ...
                          <tbody>
                            <?php $no=1;?>
                            @foreach($visitor_today as $today)
                            <tr>
                              <td>{{$no++}}</td>
                              <td>{{$today->ip_address}}</td>
                              <td>{{$today->browser}}</td>
                      ...
                      <div role="tabpanel" class="tab-pane" id="week">
                        ...
                        <table class="table table-responsive table-striped" id="table-log2" width="100%">
                          ...
                          <tbody>
                            <?php $no=1;?>
                            @foreach($visitor_mingguan as $weekly)
                            <tr>
                              <td>{{$no++}}</td>
                              <td>{{$weekly->ip_address}}</td>
                              <td>{{$weekly->browser}}</td>
                              <td>{{$weekly->created_at}}</td>
                            </tr>
                            @endforeach
                          </tbody>
                        </table>
                      ...
                      <div role="tabpanel" class="tab-pane" id="month">
                        ...
                        <table class="table table-responsive table-striped" id="table-log3" width="100%">
                          ...
                          <tbody>
                            <?php $no=1;?>
                            @foreach($visitor_bulanan as $monthly)
                            <tr>
                              <td>{{$no++}}</td>
                              <td>{{$monthly->ip_address}}</td>
                              <td>{{$monthly->browser}}</td>
                              <td>{{$monthly->created_at}}</td>
                            </tr>
                            @endforeach
                          </tbody>
                        </table>
