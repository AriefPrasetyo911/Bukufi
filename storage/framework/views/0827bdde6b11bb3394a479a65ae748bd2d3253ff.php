    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-12 table-container table-responsive">
            ...
            <table cellspacing="0" width="100%" id="table-log"
                ...
                <?php if(config('visitlog.iptolocation')): ?>
                    <thead>
                    <tr>
                        <th>#</th>
                        <th>IP</th>
                        <th>Browser</th>
                        <th>OS</th>
                        <?php if(config('visitlog.log_user')): ?>
                            <th>User</th>
                        <?php endif; ?>
                        <th>Country</th>
                        <th>Region</th>
                        ...
                        <th>Lt, Ln</th>
                        <th>Updated</th>
                        <?php if(config('visitlog.delete_log_button')): ?>
                            <th>Action</th>
                        <?php endif; ?>
                    </tr>
                    </thead>
                    ...
                    <?php $__currentLoopData = $visitlogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $visitlog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($key + 1); ?></td>
                            <td><?php echo e($visitlog->ip); ?></td>
                            <td><?php echo e($visitlog->browser); ?></td>
                            <td><?php echo e($visitlog->os); ?></td>
                            <?php if(config('visitlog.log_user')): ?>
                                <td><?php echo e($visitlog->user_name); ?> (<?php echo e($visitlog->user_id); ?>)</td>
                            <?php endif; ?>
                            <td><?php echo e($visitlog->country_name); ?></td>
                            <td><?php echo e($visitlog->region_name); ?></td>
                            <td><?php echo e($visitlog->city); ?></td>
                            <td><?php echo e($visitlog->zip_code); ?></td>
                            <td><?php echo e($visitlog->time_zone); ?></td>
                            <td><?php echo e($visitlog->latitude); ?>, <?php echo e($visitlog->longitude); ?></td>
                            <td title="<?php echo e($visitlog->updated_at); ?>"><?php echo e($visitlog->last_visit); ?></td>
                            <?php if(config('visitlog.delete_log_button')): ?>
                                <td align="center">
                                    <a title="Delete"
                                       class="confirm-delete text-danger"
                                       data-label="Visit Log"
                                       rel="<?php echo e(route('__delete_visitlog__', ['id'=>$visitlog->id])); ?>"
            ...
            <?php if(config('visitlog.delete_all_logs_button') && $visitlogs->count()): ?>
                <div align="center">
                    <a title="Delete All Logs"
                       class="confirm-delete btn btn-danger"
                       data-label="All Visit Log"
                       rel="<?php echo e(route('__delete_visitlog_all__')); ?>"
                       href="javascript:void(0);">
