...
<main class="main-content">
	...
	<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
		...
		<div class="panel panel-default trending-books">
			...
			@if(count($popular_comic_1) or count($popular_comic_2))
			<!--only for large-->
				...
				<div class="col-lg-12 no-padding-right visible-lg">
					...
					<div class="carousel carouseltrendinglg slide" id="carouselItems">
				        ...
				        <div class="carousel-inner">
			          		<div class="item active">
				        		@foreach($popular_comic_1 as $comic)
			                	<div class="col-md-3">
			                        <div class="thumbnail">
			                            <a href="{{route('single.comic', $comic->comic_title)}}">
			                            	<img src="{{asset('/storage/comic/comic_cover').'/'.$comic->comic_image}}" alt="{{$comic->comic_image}}">
			                            </a>
			                        </div>
			                        <caption>
				          	...
				          	<div class="item">
				          		@foreach($popular_comic_2 as $comic)
			                	<div class="col-md-3">
			                        <div class="thumbnail">
			                            <a href="{{route('single.comic', $comic->comic_title)}}">
			                            	<img src="{{asset('/storage/comic/comic_cover').'/'.$comic->comic_image}}" alt="{{$comic->comic_image}}">
			...
			<div class="panel-heading latest-update">
				<div class="col-lg-12 col-sm-12 hidden-xs">
					...
					<div class="col-md-6 col-sm-6 col-xs-6 right margin-top-5 margin-bottom-5 pull-right">
						<a href="{{route('latest.comic')}}"><h5 class="pull-right">VIEW MORE</h5></a>
					</div>
				</div>
				<div class="col-xs-12 visible-xs">
					<div class="col-xs-6 left margin-top-5 margin-bottom-5">
				...
				<div class="col-lg-12 col-md-12 no-padding-right visible-lg">
					@foreach($filter as $latest)
						<div class="col-md-3">
							...
							<div class="thumbnail">
	                            <a href="{{route('single.comic', $latest->comic_title)}}">
	                            	<img src="{{asset('/storage/comic/comic_cover').'/'.$latest->comic_image}}" alt="{{$latest->comic_image}}">
	                            </a>
	                        </div>
	                        <caption>
	                        	<p class="bold text-center">
	                        		...
	                        		@if(strlen($count) <= 22)
										{{str_replace('-', ' ', $latest->comic_title)}}
									@else
	                        		<?php $count = str_replace('-', ' ', $latest->comic_title)?>
										{{substr($count, 0, 22)."..."}}
									@endif
...
@if (auth()->guard('user')->user()) 
	<div class="modal fade" id="reportbug" tabindex="-1" role="dialog">
		<div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" action="{{route('send.error.comic')}}" method="post">
				{{ csrf_field() }}
