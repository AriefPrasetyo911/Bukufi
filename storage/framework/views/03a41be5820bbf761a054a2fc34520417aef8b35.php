          ...
          <div class="box">
            ...
            <div class="box-header">
              <div class="col-md-12 add">
                <div class="pull-left">
                  <a href="<?php echo e(route('comic.add')); ?>" type="button" title="Add Comic" class="btn btn-success"><i class="fa fa-plus"></i> Add Comic</a>
                </div>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="data-admin" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?php echo e($no++); ?></td>
                    <td><?php echo e(str_replace('-', ' ', $comic->comic_title)); ?></td>
                    <td><?php echo e(substr(strip_tags($comic->comic_description), 0, 450)); ?></td>
                    <td><?php echo e($comic->comic_author); ?></td>
                    <td><?php echo e($comic->comic_genre); ?></td>
                    <td><?php echo e($comic->comic_release); ?></td>
                    <!-- <td><?php echo e($comic->created_at); ?></td>
                    <td><?php echo e($comic->updated_at); ?></td> -->
                    <td>
                      <a href="<?php echo e(url('/admin/comic-chapter/' .$comic->id)); ?>" class="btn btn-primary btn-block">Add Chapter</a>
                      <a href="<?php echo e(url('/admin/comic/' .$comic->id. '/edit')); ?>" class="btn btn-info btn-block">Edit</a>
                      <form action="<?php echo e(url('/admin/comic/' .$comic->id)); ?>" class="form-horizontal" method="post">
