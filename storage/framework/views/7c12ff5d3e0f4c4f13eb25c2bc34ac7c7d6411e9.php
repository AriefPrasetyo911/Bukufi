		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 hidden-xs">
					<?php $__currentLoopData = $book_detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<div class="col-lg-6 col-md-6 col-sm-6 left">
						<figure id="description">
							<h4 id="book_desc">Book Description</h4>
							<caption>
								<?php echo e(strip_tags($detail->book_description)); ?>
						...
						<figure id="author">
							...
							<caption>
								<?php echo e(str_replace('-', ' ', $detail->book_author)); ?>
						...
						<figure id="publisher">
							...
							<caption>
								<?php echo e(str_replace('-', ' ', $detail->book_publisher)); ?>
						...
						<figure id="release">
							...
							<caption>
								<?php echo e($detail->book_release); ?>

							</caption>
						</figure>
					</div>

					<a href="<?php echo e(url('book/read').'/'.$detail->book_title); ?>" id="link">
						<div class="col-lg-6 col-md-6 col-sm-6 right">
							<div class="col-lg-4 col-md-4 col-sm-5" id="outer-thumb">
								<div class="thumbnail">
		                            <img src="<?php echo e(asset('/theme/book/book_cover').'/'.$detail->book_image); ?>" alt="<?php echo e($detail->book_image); ?>">
		                        </div>
							</div>
							<div class="col-lg-8 col-md-8 col-sm-7" id="outer-content">
								<figure id="title">
									<h4 id="book_title"><?php echo e(str_replace('-', ' ', $detail->book_title)); ?></h4>
								</figure>
