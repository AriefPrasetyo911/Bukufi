...
<head>
  ...
  <title>Comic Chapter : Bukufi</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
          <ol class="breadcrumb">
            ...
            <li class="active">Comic Chapter</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Comic Chapter List</h3>
            ...
            <div class="box-body">
              <table id="data-admin" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?php echo e($no++); ?></td>
                    <td><?php echo e($chap->comic_title); ?></td>
                    <td><?php echo e($chap->comic_chapter); ?></td>
                    <td><?php echo e($chap->chapter_title); ?></td>
                    <!-- <td>
                      <form action="<?php echo e(url('/admin/comic-chapter/delete/' .$chap->comic_chapter)); ?>" class="form-horizontal" method="post">
    ...
    <div class="modal fade" id="add">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form class="form-horizontal" action="<?php echo e(route('add.admin')); ?>" method="post">
          <?php echo e(csrf_field()); ?>
