...
<main class="main-content col-sm-12 col-md-12 col-xs-12">
					...
					<tbody>
						...
						<?php if(count($script)): ?>
							...
							<tr>
								<td><?php echo e($no++); ?></td>
								<td>
									<a href="<?php echo e(url('/comic').'/'.$data->comic_title); ?>" title="<?php echo e(str_replace('-', ' ', $data->comic_title)); ?>"><?php echo e(str_replace('-', ' ', $data->comic_title)); ?></a>
								</td>
								<td><?php echo e(str_replace('-', ' ', $data->comic_author)); ?></td>
								<td><?php echo e($data->comic_status); ?></td>
							</tr>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						<?php else: ?>
							<tr>
								<td colspan="4" id="sorry">Sorry, no data available to display</td>
							</tr>
						<?php endif; ?>
					</tbody>
				</table>
				<?php echo e($script->links('pagination.custom')); ?>
	...
	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
		...
		<div class="panel panel-default hidden-xs">
			<div class="panel-heading">
				...
				<div class="pull-right pull-right2 margin-top-5 margin-bottom-5">
		...
		<div class="panel panel-default visible-xs">
			<div class="panel-heading">
				<div class="pull-left col-xs-6 margin-bottom-5">
					<h4>Genre</h4>
				</div>
				<div class="pull-right col-xs-6 pull-right2 margin-top-5 margin-bottom-5">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="col-sm-12 status margin-top-5 margin-bottom-5">
					<h4>Comic Status</h4>
				</div>
			</div>
			<div class="panel-body">
