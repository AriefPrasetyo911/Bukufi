...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box">
            <!-- /.box-header -->
            <form class="form-horizontal" action="{{route('update.book', $books->id)}}" method="post" enctype="multipart/form-data">
            {{ method_field('patch')}}
            {{ csrf_field() }}
            <div class="box-body">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <input type="text" name="book_title" id="book_title" class="form-control" value="{{str_replace('-', ' ', $books->book_title)}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-md-2">Book Cover</label>
                  <div class="col-md-10">
                    <input type="file" name="book_image" id="book_image" class="form-control" value="{{$books->book_image}}">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <input type="text" name="book_author" id="book_author" class="form-control" value="{{str_replace('-', ' ', $books->book_author)}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-md-2">Comic Publisher</label>
                  <div class="col-md-10">
                    <input type="text" name="book_publisher" id="book_publisher" class="form-control" value="{{$books->book_publisher}}">
                  </div>
                </div>
                <div class="form-group">
