...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box">
            <!-- /.box-header -->
            <form class="form-horizontal" action="<?php echo e(route('update.book', $books->id)); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <input type="text" name="book_title" id="book_title" class="form-control" value="<?php echo e(str_replace('-', ' ', $books->book_title)); ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-md-2">Book Cover</label>
                  <div class="col-md-10">
                    <input type="file" name="book_image" id="book_image" class="form-control" value="<?php echo e($books->book_image); ?>">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <textarea name="book_description" id="book_description" rows="10" cols="60">
                      <?php echo e($books->book_description); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <input type="text" name="book_author" id="book_author" class="form-control" value="<?php echo e(str_replace('-', ' ', $books->book_author)); ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-md-2">Comic Publisher</label>
                  <div class="col-md-10">
                    <input type="text" name="book_publisher" id="book_publisher" class="form-control" value="<?php echo e($books->book_publisher); ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-md-2">Book Release</label>
                  <div class="col-md-10">
                    <input type="number" name="book_release" id="book_release" class="form-control" value="<?php echo e($books->book_release); ?>">
                  </div>
                </div>
              </div>
            </div>
