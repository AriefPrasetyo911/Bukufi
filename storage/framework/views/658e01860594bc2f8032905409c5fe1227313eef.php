          ...
          <div class="box">
            ...
            <div class="box-header">
              <div class="col-md-12 add">
                <div class="pull-left">
                  <a href="<?php echo e(route('add.book')); ?>" type="button" title="Add Comic" class="btn btn-success"><i class="fa fa-plus"></i> Add New Book</a>
                </div>
              </div>
            </div>
            <!-- /.box-header -->
                ...
                <tbody>
                  <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo e(route('edit.book', $book->id)); ?>" class="btn btn-info btn-block">Edit</a>

                        <form action="<?php echo e(route('delete.book', $book->id)); ?>" class="form-horizontal" method="post">
